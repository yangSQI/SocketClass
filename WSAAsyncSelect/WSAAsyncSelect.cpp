                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WSAASYNCSELECT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = NULL; // MAKEINTRESOURCEW(IDC_WSAASYNCSELECT);
...
{
	static AsyncSelect asyncSelect(88, hWnd);
    switch (message)
    {
    case WM_COMMAND:
        {
